...
function makeTodo(data,timestamp,listCompleted) {
...
{
    const taskTile = taskElement.querySelector(".inner > h2").innerText;
    const taskTimeStamp = taskElement.querySelector(".inner > p").innerText;

    const newTodo = makeTodo(taskTile,taskTimeStamp, true);
